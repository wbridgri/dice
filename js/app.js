 ...
 *      ELSE IF (total equal 7 or total equal to eleven ) AND rolls is equal to 1
 *      SET win to true
 *      SET gamplay to !win
...
//4
    checkWin(total, rolls) {
        ...
        if(total === 2) {
            ...
            this.gameSettings.gamePlay = false;
        }else if (total === gameStartBtn.point && rolls > 1) {
            this.gameSettings.win = true;
        }else {
...
/**
 *  Promise => object that represents the eventual completion or failure of an asynchronous value
 * 
 * 
